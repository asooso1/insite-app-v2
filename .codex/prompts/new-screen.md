---
description: "시니어 모드가 적용된 새 화면 템플릿 생성"
argument-hint: "경로 [--type=form|detail|list]"
---
# 새 화면 생성
...
```bash
/prompts:new-screen work/create      # app/(main)/work/create.tsx 생성
/prompts:new-screen patrol/scan      # app/(main)/patrol/scan.tsx 생성
```
...
```bash
/prompts:new-screen work/create --type=form    # 폼 화면 템플릿
/prompts:new-screen work/result --type=detail  # 상세 화면 템플릿
/prompts:new-screen patrol/list --type=list    # 목록 화면 템플릿
```

        ...
        >
          ...
          >
            ...
            <Pressable onPress={handleSubmit} disabled={!isFormValid}>
              <XStack
                backgroundColor={isFormValid ? 'rgba(255, 255, 255, 0.25)' : 'rgba(255, 255, 255, 0.1)'}
                paddingHorizontal="$4"
                paddingVertical="$2"
                borderRadius={12}
                alignItems="center"
          ...
          <YStack paddingHorizontal="$5" paddingTop="$2">
            <Text fontSize={isSeniorMode ? 28 : 24} fontWeight="800" color="$white" letterSpacing={-0.5}>
              일상업무 등록
            </Text>
            ...
            <GlassCard floating intensity="heavy">
              ...
              {isBasicInfoExpanded && (
                <YStack gap="$3" marginTop="$3">
                  ...
                  <InfoRow label="담당그룹" value={MOCK_CURRENT_USER.buildingUserGroupName || '-'} />
        ...
        <View>
          ...
          >
            <GlassCard intensity="medium">
              ...
              <YStack marginTop="$3">
                <Text fontSize={isSeniorMode ? fontSize.small : 14} color="$gray700" marginBottom="$2">
        ...
        <View>
          ...
          >
            <GlassCard intensity="light">
              <XStack justifyContent="space-between" alignItems="center">
                <Text fontSize={isSeniorMode ? fontSize.medium : 16} fontWeight="600" color="$gray900">
                  Push 알림여부
                </Text>
                <Switch
                  value={isAlertPush}

          ...
          >
            <GlassCard intensity="medium">
              ...
              <YStack gap="$3" marginTop="$2">
                <InfoRow
                  label="담당자"
                  value={facility.managerName}
                  isSeniorMode={isSeniorMode}
                  fontSize={fontSize}
                />
                <InfoRow
                  label="연락처"
                  value={facility.managerPhone}
                  isSeniorMode={isSeniorMode}
                  fontSize={fontSize}
                />
              </YStack>
                ...
                <FilterContainer>
                    ...
                    <FilterItem>
                      ...
                      >
                        <Text fontSize={14} color="$gray900">
                          {WORK_TYPE_OPTIONS.find((o) => o.value === filter.workType)?.label ||
                            '전체'}
                        </Text>
                      </View>
                    </FilterItem>
                  ...
                  {filter.workType === '1' && (
                    <FilterRow>
                      <FilterItem>
                        ...
                        >
                          <Text fontSize={14} color="$gray900">
                            {WORK_ORDER_TYPE_OPTIONS.find((o) => o.value === filter.workOrderType)
                              ?.label || '수시업무'}
                          </Text>
                        </View>
                      </FilterItem>
                  ...
                  {filter.workType === '-1' && (
                    <FilterRow>
                      <FilterItem>
                        ...
                        >
                          <Text fontSize={14} color="$gray900">
                            {HISTORY_TYPE_OPTIONS.find((o) => o.value === filter.historyType)
                              ?.label || '전체'}
                          </Text>
                        </View>
                      </FilterItem>
                      <FilterItem>
                        ...
                        >
                          <Text fontSize={14} color="$gray900">
                            {WORK_SOURCE_TYPE_OPTIONS.find((o) => o.value === filter.workSourceType)
                              ?.label || '전체'}
                          </Text>
                        </View>
                      </FilterItem>
                  ...
                  <FilterRow>
                    <FilterItem>
                      ...
                      >
                        <Text fontSize={14} color="$gray900">
                          {SEARCH_TYPE_OPTIONS.find((o) => o.value === filter.searchType)?.label ||
                            '업무명'}
                        </Text>
                      </View>
                    </FilterItem>
